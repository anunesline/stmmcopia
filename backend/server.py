...
async def seed_data():
    ...
    if count == 0:
        ...
        products = [
            ...
            ("Saco de Lixo Reforçado 100L", "descartaveis", descart_img, False, "Saco de lixo reforçado, embalagem com 100 unidades."),
            ("Luva Descartável Nitrílica", "descartaveis", descart_img, False, "Luva nitrílica descartável sem pó, caixa com 100 unidades."),
            ("Papel Toalha Interfolhado", "papeis", papel_img, False, "Papel toalha interfolhado branco luxo, fardo com 1000 folhas."),
            ("Papel Higiênico Profissional 300m", "papeis", papel_img, False, "Papel higiênico folha dupla 300m, uso comercial."),
        ]
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Isso libera acesso para QUALQUER site, sem erro de CORS
